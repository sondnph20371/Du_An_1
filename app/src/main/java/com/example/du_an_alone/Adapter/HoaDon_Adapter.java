...
public class HoaDon_Adapter extends ArrayAdapter<HoaDon> {
    ...
    ImageView btnxoa;
    public HoaDon_Adapter(Context context , Hoa_DonFragment fragment, ArrayList<HoaDon> list) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view==null){
            ...
            view = inflater.inflate(R.layout.item_hoa_don, null);
        }
        ...
        if (hoaDon!=null){
            ...
            btnxoa = view.findViewById(R.id.btnxoahoadon);
            btnxoa.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    fragment.xoa(String.valueOf(hoaDon.getMaHoaDon()));
                }
            });
        }
        return view;
