...
public class Phong_Adapter_Activity extends ArrayAdapter<Phong> {
    Context context;
    ArrayList<Phong> listP;
    Phong_Activity activity;
    LoaiPhong loaiPhong;
    ...
    public Phong_Adapter_Activity(Context context, Phong_Activity activity , ArrayList<Phong> listP) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view==null){
            ...
            view = inflater.inflate(R.layout.item_phong_activity, null);
        }
