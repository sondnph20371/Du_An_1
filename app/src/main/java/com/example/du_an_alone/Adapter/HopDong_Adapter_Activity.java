...
public class HopDong_Adapter_Activity extends ArrayAdapter<HopDong> {
            Context context;
    ...
    public HopDong_Adapter_Activity(Context context, HopDong_Activity activity , ArrayList<HopDong> listHopDong) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view==null){
            ...
            view = inflater.inflate(R.layout.item_hopdong_activity , null);
        }
