...
public class DichVu_Adapter extends ArrayAdapter<DichVu> {
    Context context;
    ArrayList<DichVu> listDV;
    DichVu_Activity activity;
    TextView tvMaDichVu, tvTienDien , tvTienNuoc , tvTienveSinh , tvTienGuiXe , tvTienDieuHoa , tvTienWifi;
    ImageView btnxoa;
    DichVu_Fragment fragment;
    public DichVu_Adapter( Context context, DichVu_Fragment fragment,ArrayList<DichVu> listDV) {
        super(context, 0, listDV);
        this.context = context;
        this.listDV = listDV;
        this.fragment = fragment;
    }
    public DichVu_Adapter( Context context, DichVu_Activity activity,ArrayList<DichVu> listDV) {
        super(context, 0, listDV);
        this.context = context;
        this.listDV = listDV;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view==null){
            ...
            view = inflater.inflate(R.layout.item_dichvu, null);
        }
        ...
        if (dichVu!=null){
            ...
            btnxoa.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    fragment.xoa(String.valueOf(dichVu.getMaDichVu()));
                }
            });
        }
        return view;
