...
public class KhachThue_Adapter_Activity extends ArrayAdapter<KhachThue> {
    ...
    public KhachThue_Adapter_Activity(@NonNull Context context, KhachThue_Activity activity, List<KhachThue> listkhachthue) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view==null){
            ...
            view = inflater.inflate(R.layout.item_khachthue_activity, null);
        }
        phong = new Phong();
